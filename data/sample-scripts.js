...
(function (global) {
  ...
  var SAMPLE_SCRIPTS = [
    /* ===================== Part 1. 묘사·서술형 ===================== */
    {
      ...
      keywords: ["overwhelmed", "go-to park", "job hunting", "running shoes", "jog + walk", "resets my brain", "no big deal", "cheapest therapy"],
      structure: [
        { label: "상황", range: [1, 2] },
        { label: "행동", range: [3, 4] },
        { label: "감정", range: [5, 6] },
      ...
      extras: {
        ko: "뭔가에 압도당하는 기분이 들 때면, 제가 늘 찾는 곳은 집에서 10분쯤 떨어진 공원이에요. 솔직히 말하면 지금 취업 준비 중이라, 결과를 기다리는 게 인정하고 싶은 것보다 더 힘들거든요. 그래서 스트레스를 받으면 러닝화를 신고 그냥 나가요. 보통 강변 산책로를 따라 천천히 달리기 시작해서 긴 걷기로 마무리해요. 달리는 리듬이랑 선선한 아침 공기에는 뭔가 머리를 리셋시켜 주는 게 있어요. 집에 돌아올 때쯤이면, 한 시간 전엔 거대해 보였던 고민들이 더 이상 별일 아니게 느껴져요. 솔직히 제가 아는 가장 값싼 치료법이에요.",
        pron: "웬에붤 아임 필링 오우벌웰름드, 마이 고우-투 플레이스 이저 팍 어바웃 텐 미닛츠 프럼 마이 아팟먼(트). 아일 비 아-니스트 — 아임 좝 헌팅 앳 더 모먼트, 앤 더 웨이링 풔 뤼절츠 겟츠 투 미 모어 댄 아이드 라익 투 엇밋. 쏘 웬 아이 겟 스트뤠스트, 아이 쓰로우 온 마이 뤄닝 슈즈 앤 헤드 아웃. 아이 유절리 스탓 바이 뤄닝 슬로울리 얼롱 더 뤼버 츄뤠일 앤 덴 쿨 다운 위더 롱 웤. 데얼즈 썸띵 어바웃 더 뤼듬 어브 뤄닝 앤 더 쿨 모닝 에얼 댓 저슷 뤼셋츠 마이 브뤠인. 바이 더 타임 아이 겟 홈, 더 프롸블럼즈 댓 펠트 휴-지 언 아워 어고우 아 낫 어 빅 딜 애니모어. 이츠 아-니슬리 더 칲이스트 떼뤄피 아이 노우."
      }
    },
    {
